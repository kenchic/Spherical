...
{
    public partial class BdMantenimiento
    {
        public BdMantenimiento()
        {
            BdMantenimientoDetalles = new HashSet<BdMantenimientoDetalle>();
        }
        ...
        public virtual ICollection<BdMantenimientoDetalle> BdMantenimientoDetalles { get; set; }
    }
}

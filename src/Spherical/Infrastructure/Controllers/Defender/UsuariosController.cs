...
namespace Spherical.Infrastructure.Controllers.Defender
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        // GET: api/Usuarios
        [HttpGet]
        public async Task<ActionResult<ApiResponse<IEnumerable<UsuarioDTO>>>> Usuarios()
        {
        ...
        // GET: api/Usuarios/5
        [HttpGet("{id}")]
        public async Task<ActionResult<ApiResponse<UsuarioDTO>>> Usuario(string id)
        {
            if (_context.Usuarios == null)
            {
                return NotFound();

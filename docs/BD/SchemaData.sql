USE [master]
GO
/****** Object:  Database [Spherical]    Script Date: 05/02/2025 8:23:05 PM ******/
CREATE DATABASE [Spherical]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Spherical', FILENAME = N'/var/opt/mssql/data/Spherical.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Spherical_log', FILENAME = N'/var/opt/mssql/data/Spherical_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [Spherical] SET COMPATIBILITY_LEVEL = 160
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Spherical].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [Spherical] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [Spherical] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [Spherical] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [Spherical] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [Spherical] SET ARITHABORT OFF 
GO
ALTER DATABASE [Spherical] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [Spherical] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [Spherical] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [Spherical] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [Spherical] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [Spherical] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [Spherical] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [Spherical] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [Spherical] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [Spherical] SET  DISABLE_BROKER 
GO
ALTER DATABASE [Spherical] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [Spherical] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [Spherical] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [Spherical] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [Spherical] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [Spherical] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [Spherical] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [Spherical] SET RECOVERY FULL 
GO
ALTER DATABASE [Spherical] SET  MULTI_USER 
GO
ALTER DATABASE [Spherical] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [Spherical] SET DB_CHAINING OFF 
GO
ALTER DATABASE [Spherical] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [Spherical] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Spherical] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [Spherical] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'Spherical', N'ON'
GO
ALTER DATABASE [Spherical] SET QUERY_STORE = ON
GO
ALTER DATABASE [Spherical] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
USE [Spherical]
GO
/****** Object:  User [Spherical]    Script Date: 05/02/2025 8:23:05 PM ******/
CREATE USER [Spherical] FOR LOGIN [Spherical] WITH DEFAULT_SCHEMA=[Spherical]
GO
/****** Object:  Schema [Spherical]    Script Date: 05/02/2025 8:23:05 PM ******/
CREATE SCHEMA [Spherical]
GO
/****** Object:  Table [Spherical].[Catalogo]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [Spherical].[CatalogoDetalle]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Cliente]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Elemento]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Factura]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Grupo]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[GrupoRol]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[GrupoUsuario]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[ListaPrecio]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Menu]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Opcion]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Parametro]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Permiso]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[PermisoMenu]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[PermisoOpcion]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Proyecto]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Rol]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[RolPermiso]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Sistema]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Ticket]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[Usuario]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [Spherical].[UsuarioRol]    Script Date: 05/02/2025 8:23:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [Spherical].[GrupoRol] ([idGrupo], [idRol]) VALUES (N'GPlus', N'RInformesPlus')
GO
...
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MFactura', N'AYZCORP', NULL, N'Facturas', NULL, 5, N'fa-solid fa-file-invoice-dollar', 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MFacturaConsultar', N'AYZCORP', N'MFactura', N'Consultar', N'/Factura/Consultar', 1, NULL, 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MInformes', N'AYZCORP', NULL, N'Informes', NULL, 6, N'fa-solid fa-chart-line', 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MInformesInventario', N'AYZCORP', N'MInformes', N'Inventario', N'/Informes/Inventario', 1, NULL, 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MInventario', N'AYZCORP', NULL, N'Inventario', NULL, 3, N'fa-solid fa-boxes-stacked', 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MIventarioConsultar', N'AYZCORP', N'MInventario', N'Consultar', N'/Inventario/Consultar', 1, NULL, 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MParametro', N'AYZCORP', NULL, N'Patrametros', NULL, 2, N'fa-solid fa-gears', 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MParametroConsultar', N'AZYCORP', N'MParametro', N'Consultar', N'/Parametro/Consultar', 1, NULL, 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MProyecto', N'AYZCORP', NULL, N'Proyectos', NULL, 4, N'fa-solid fa-trowel-bricks', 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MProyectoConsultar', N'AYZCORP', N'MProyecto', N'Consultar', N'/Proyecto/Consultar', 1, NULL, 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MUsuario', N'AYZCORP', NULL, N'Usuarios', NULL, 1, N'fa-solid fa-user-gear', 1)
GO
INSERT [Spherical].[Menu] ([Id], [Empresa], [idMenu], [Nombre], [Url], [Orden], [Icono], [Activo]) VALUES (N'MUsuarioConsultar', N'AYZCORP', N'MUsuario', N'Consultar', N'/Usuario/Consultar', 1, NULL, 1)
GO
...
GO
INSERT [Spherical].[Opcion] ([Id], [Empresa], [Descripcion], [Consultar], [Crear], [Editar], [Eliminar], [Anular], [Activar]) VALUES (N'OInformes', N'AYZCORP', N'Opciones de la pagina informes', 1, 0, 0, 0, 0, 1)
GO
...
GO
INSERT [Spherical].[Permiso] ([Id], [Empresa], [Nombre], [Descripcion], [Activo]) VALUES (N'PInformesMenu', N'AYZCORP', N'Menu Informes', N'Permiso para ver menu de informes', 1)
GO
INSERT [Spherical].[Permiso] ([Id], [Empresa], [Nombre], [Descripcion], [Activo]) VALUES (N'PInformesPlus', N'AYZCORP', N'Opcions Usuario Plus', N'Permite consultar , crea, editar , elimnar un Informe', 1)
GO
...
GO
INSERT [Spherical].[PermisoMenu] ([idPermiso], [idMenu]) VALUES (N'PInformesMenu', N'MInformes')
GO
...
GO
INSERT [Spherical].[PermisoOpcion] ([idPermiso], [idOpcion], [Consultar], [Crear], [Editar], [Eliminar], [Anular], [Activar]) VALUES (N'PInformesPlus', N'OInformes', 1, 0, 0, 0, 0, 1)
GO
...
GO
INSERT [Spherical].[Rol] ([Id], [Empresa], [Nombre], [Descripcion], [Activo]) VALUES (N'RInformesPlus', N'AYZCORP', N'Informe Plus', N'Rol para gestionar como admin del modulo informes', 1)
GO
...
GO
INSERT [Spherical].[RolPermiso] ([idRol], [idPermiso]) VALUES (N'RInformesPlus', N'PInformesMenu')
GO
...
GO
/****** Object:  StoredProcedure [Spherical].[GetMenuUsuario]    Script Date: 05/02/2025 8:23:06 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [master]
GO
ALTER DATABASE [Spherical] SET  READ_WRITE 
GO
